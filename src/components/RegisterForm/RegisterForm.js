...
class RegisterForm extends Component {
  state = {
      ...
      errorObjects: {
          firstNameError: {
              text: this.props.t("errors.firstName"),
              active: false,
              justEmpty: false
          },
          lastNameError: {
              text: this.props.t("errors.lastName"),
              active: false,
              justEmpty: false
          },
          emailError: {
              ...
              <div ref={this.formFrame} className="frame form_frame-vert">
                  <h4
                      ...
                      dangerouslySetInnerHTML={{
                          __html: offer.indexOf("freeticket") !== -1 ? t("titleFree") : t("titleNotFree")
                      }}
                  />
                      ...
                      <div className="form_step2_bottom">
                          ...
                          <button type="submit" className="btn-general btn-green form_submit-btn">
                              {offer.indexOf("freeticket") !== -1
                                  ? t("buttons.freeticketSubmit")
                                  : t("buttons.notfreeSubmit")}
                          </button>
